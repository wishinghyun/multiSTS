...
public class ChatLogin extends JFrame {
	 ...
	 JComboBox cboPort;
	 JButton btnConnect;
	 String[] ip = {"70.12.116.53","70.12.116.50","127.0.0.1"}; //셀렉박스에 들어갈 정보는 배열로 정의
	 String[] port = {"12345"};
	/**
	 ...
	 */
	public ChatLogin() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //상단 X버튼 누르면 종료되는 기능
		setBounds(100, 100, 320, 529);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		contentPane.setLayout(null); //레이아웃 세팅하는 기능 (null은 세팅하지 않고 직접 구성한다는 의미)
		...
		txtId = new JTextField(); //JTextField = editText
