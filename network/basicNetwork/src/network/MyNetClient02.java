...
public class MyNetClient02 { //클라이언트 페이지
	public static void main(String[] args) {
		...
		try {
			socket = new Socket("70.12.115.57", 12345);//소켓 생성하는게 접속하는거
			...
			System.out.println("서버가 전송하는 메시지1 : "+intdata);
			
			//2. 클라이언트 -> 서버
			dos.writeUTF("안녕하세요 서버님 클라이언트 입니다.");
